 ...
 * The output should be a single integer number – the number of word occurrences. Matching should be case-insensitive.
...
class CountingAWordInAText
{
    static void Main()
    {
        ...
        List<string> word = new List<string>(text.Split(new char[] { ' ', '.', ',', ';', '!', '"', '(', ')', '@', '/', '“', '”', '\\', '?' },
